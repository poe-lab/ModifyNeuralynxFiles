function downsample28kHzto1kHzCSC_v03232016
...
Samples = Samples(1:28:newM);
[m2,n2]=size(Samples);
newEnd = floor(m2/512);
shortEnd = newEnd * 512;
Samples = Samples(1:shortEnd);
Samples = reshape(Samples, m1, newEnd);
Timestamps = Timestamps(1:28:n1);
ChannelNumbers =ChannelNumbers(1:28:n1);
SampleFrequencies = SampleFrequencies(1:28:n1);
NumberOfValidSamples =NumberOfValidSamples(1:28:n1);
Timestamps = Timestamps(1:newEnd);
ChannelNumbers =ChannelNumbers(1:newEnd);
SampleFrequencies = SampleFrequencies(1:newEnd)./28;
